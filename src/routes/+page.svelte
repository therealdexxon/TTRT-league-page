<script>
  ...
  // NFL State, Awards, and League Team Managers Data
  ...
  let countdownText = '';
  const countdownDate = new Date('2025-08-31T00:00:00-05:00'); // Set to the draft date (Central Time)
...
<style>
  ...
  #countdown-timer {
    font-size: 1.8em;
    font-weight: bold;
    color: #f5a623; /* Adjust the color to match your theme */
    padding: 15px;
    background-color: #00316b; /* Adjust the background color */
    text-align: center;
    border-radius: 5px;
    margin-top: 20px;
    width: 100%;
